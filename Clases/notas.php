...
$id_nota=$ini_u.verCodLong($acceso,"id_nota");
		...
		return $acceso->objeto->ejecutarSql("insert into notas(id_nota,login,id_cont_serv,tipo,dir_ip,fecha,hora,monto_anterior,monto_posterior,idmotivonota,comentario,status,generado_por,id_contrato,nro_nota,monto_nota) values ('$id_nota','$this->login','$this->id_cont_serv','$this->tipo','$this->dir_ip','$this->fecha','$this->hora','$this->monto_anterior','$this->monto_posterior','$this->idmotivonota','$this->comentario','$this->status','$this->generado_por','$this->id_contrato','$nro_nota','$monto_nota')");
	}
...
$id_nota=$ini_u.verCodLong($acceso,"id_nota");
		...
		return $acceso->objeto->ejecutarSql("insert into notas(id_nota,login,id_cont_serv,tipo,dir_ip,fecha,hora,monto_anterior,monto_posterior,idmotivonota,comentario,status,generado_por,id_contrato,nro_nota,monto_nota,servicio,fecha_inst) values ('$id_nota','$this->login','$this->id_cont_serv','$this->tipo','$this->dir_ip','$this->fecha','$this->hora','$this->monto_anterior','$this->monto_posterior','$this->idmotivonota','$this->comentario','$this->status','$this->generado_por','$this->id_contrato','$nro_nota','$monto_nota','$servicio','$fecha_inst')");
	}
