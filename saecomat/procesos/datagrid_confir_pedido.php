...
$x->setQuery("id_ped,num_ped,id_prov,fecha_ped,status_ped,nombre_prov,rif_prov", "vista_pedido","id_ped","status_ped='SOLICITADO'");
$x->hideColumn('id_ped');
...
//
$x->addRowSelect("cargarDatosP('%id_ped%','%id_prov%')");
/*
