...
$x->setQuery("id_m,id_mat,numero_mat,nombre_mat,nombre_dep,nombre_fam,nombre_unidad,us_nombre,observacion", "vista_materiales_unid","id_m",$bus);
$x->hideColumn('id_m');
$x->hideColumn('id_mat');
$x->hideColumn('id_dep');
...
$x->addRowSelect("ImprimirRep_reporteinventario();");
