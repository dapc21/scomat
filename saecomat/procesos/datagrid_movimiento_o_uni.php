...
$x->setQuery("c_uni_sal,c_uni_ent,abreviatura,us_abre,id_mat,id_m,numero_mat,nombre_mat,nombre_dep,nombre_fam,nombre_unidad,stock_min,cant_mov as stock,stock_min as min","vista_mov_mat_o","id_mat",$bus);
$x->hideColumn('id_mat');
...
$x->addStandardControl(EyeDataGrid::STDCTRL_EDIT, "valida_mov_mta_new02_orden('%id_mat%');mod_mov_mat()");
//para activar el boton eliminar
$x->addStandardControl(EyeDataGrid::STDCTRL_DELETE, "eliminar_mov_mta_orde('%id_mat%','%id_m%')");
