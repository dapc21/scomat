...
<form name="f1">
	<table border="1" width="420px" align="CENTER" bordercolor="" > 
		<tr>
			...
			<td>
				<input  type="text" name="codigo" maxlength="7" size="25"onChange="validarCodigo_mat()" value="<?php echo "PERF".verCodigo($acceso,'codigoperfil')?>">
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td colspan="2" rowspan="1">
				...
				<div align="center">
					<input  type="button" name="registrar" value="REGISTRAR" onclick="verificar_mat('incluir','Perfil')">&nbsp;
					<input  type="button" name="modificar" value="MODIFICAR" onclick="verificar_mat('modificar','Perfil')">&nbsp;
					<input  type="button" name="eliminar" value="ELIMINAR" onclick="verificar_mat('eliminar','Perfil')">&nbsp;
