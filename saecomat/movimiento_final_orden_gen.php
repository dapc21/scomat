...
<fieldset >
	<header class="panel-heading">materiales utilizados en la realizacion de la orden</header>
	<img class="imagen" src="imagenes/buscar.png" height="20px" width="20px"href="#" onclick="Busqueda_mat_avan_new()" />
...
<table border="0" width="97%" align="CENTER" > 
				...
				<input  type="hidden" name="tipo_mov" maxlength="20" size="30" value="MATERIALES" >
					...
					<input  type="hidden" name="iddep"  id="iddep" maxlength="15" size="30" value="<?php echo $id_deposito;?>" onchange="valIqualD();traermat();">
