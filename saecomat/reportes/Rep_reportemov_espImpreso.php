...
class PDF extends FPDF
{
	...
	function TituloCampos()
	{
		...
		$w=array(10,15,57,26,26,46);//12
		$header=array('#',strtoupper(_('num mat')),strtoupper(_('nombre mat')),strtoupper(_('entrada')),strtoupper(_('salida')),strtoupper(_('stock act.')));
	...
	function Cuerpo($acceso,$id_dep,$desde,$hasta,$tipo_ent_sal,$id_tm,$id_te,$id_persona)
	{
		$sq='';
...
$pdf->Titulo();
$pdf->Fecha();
$pdf->Cuerpo($acceso,$d_dep,$desde,$hasta,$tipo_ent_sal,$id_tm,$id_te,$id_persona);
