CREATE TABLE modulo (  codigomodulo char(7) NOT NULL,  nombremodulo char(25) default NULL,  descripcionmodulo varchar(1000) default NULL,  statusmodulo char(8) default NULL,  namemodulo varchar(50) NOT NULL);
...
CREATE TABLE moduloperfil (  codigoperfil char(7) NOT NULL,  codigomodulo char(7) NOT NULL,  incluir char(5) NOT NULL,  modificar char(5) NOT NULL,  eliminar char(5) NOT NULL);
...
CREATE TABLE perfil (  codigoperfil char(7) NOT NULL,  nombreperfil char(25) NOT NULL,  descripcionperfil varchar(1000) default NULL,  statusperfil char(8) default NULL,  PRIMARY KEY  (codigoperfil));

INSERT INTO perfil VALUES ('PERF001', 'Administrador', 'administrador de la aplicacion', 'Activo');

CREATE TABLE persona (  dato char(10) default NULL,  idPersona char(8) NOT NULL,  cedula char(8) default NULL,  nombre char(30) default NULL,  apellido char(30) default NULL,  PRIMARY KEY  (idPersona));

INSERT INTO persona (dato, idPersona, cedula, nombre, apellido) VALUES ('dato', 'COD00001', '12345678', 'Admin', 'Admin');

CREATE TABLE usuario (  login char(15) NOT NULL,  codigoperfil char(7) NOT NULL,  cedulaempleado char(9) NOT NULL,  password char(25) NOT NULL,  statususuario char(8) NOT NULL);
