...
--
-- TOC entry 322 (class 1259 OID 4539111)
-- Dependencies: 2944 6
...
--
-- TOC entry 323 (class 1259 OID 4539115)
-- Dependencies: 2945 6
...
--
-- TOC entry 329 (class 1259 OID 4539140)
-- Dependencies: 2950 6
...
CREATE OR REPLACE VIEW vista_ciudad AS 
 SELECT ciudad.id_ciudad, ciudad.id_mun, ciudad.nombre_ciudad, ciudad.status_ciudad, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, estado.nombre_esta, estado.status_esta
   FROM ciudad
...
--
-- TOC entry 330 (class 1259 OID 4539144)
-- Dependencies: 2951 6
...
CREATE OR REPLACE VIEW vista_cliente1 AS 
...
--
-- TOC entry 332 (class 1259 OID 4539152)
-- Dependencies: 2953 6
...
--
-- TOC entry 333 (class 1259 OID 4539156)
-- Dependencies: 2954 6
...
--
-- TOC entry 334 (class 1259 OID 4539160)
-- Dependencies: 2955 6
...
--
-- TOC entry 431 (class 1259 OID 4566155)
-- Dependencies: 3037 6
-- Name: vista_cont_serv_temp; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_cont_serv_temp AS
    SELECT contrato_servicio_temp.id_cont_serv, contrato_servicio_temp.id_serv, contrato_servicio_temp.id_contrato, contrato_servicio_temp.fecha_inst, contrato_servicio_temp.cant_serv, contrato_servicio_temp.status_con_ser, servicios.id_tipo_servicio, servicios.nombre_servicio, tipo_servicio.tipo_servicio, contrato_servicio_temp.costo_cobro,tipo_paq FROM contrato_servicio_temp, tipo_servicio, servicios WHERE ((contrato_servicio_temp.id_serv = servicios.id_serv) AND (servicios.id_tipo_servicio = tipo_servicio.id_tipo_servicio));


ALTER TABLE public.vista_cont_serv_temp OWNER TO postgres;

--
-- TOC entry 335 (class 1259 OID 4539165)
-- Dependencies: 2956 6
...
--
-- TOC entry 336 (class 1259 OID 4539170)
-- Dependencies: 2957 6
...
--
-- TOC entry 337 (class 1259 OID 4539175)
-- Dependencies: 2958 6
-- Name: vista_contrato1; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_contrato1 AS
...
--
-- TOC entry 338 (class 1259 OID 4539180)
-- Dependencies: 2959 6
...
CREATE OR REPLACE VIEW vista_contrato_auditoria AS 
 ...
 urbanizacion.nombre_urb as urbanizacion,contrato_fisico, cliente.tipo_cliente, cliente.inicial_doc, cliente.fecha_nac,contrato.observacion,statuscont.nombrestatus,contrato.contrato_imp,contrato.ultima_act,cliente.email,venta_contrato.id_persona,venta_contrato.id_serv as id_serv_v
   ...
   LEFT JOIN edificio on contrato.id_edif=edificio.id_edif
   LEFT JOIN urbanizacion on contrato.id_urb=urbanizacion.id_urb;
   LEFT JOIN venta_contrato on contrato.id_venta=venta_contrato.id_venta;

ALTER TABLE public.vista_contrato_auditoria OWNER TO postgres;

--
-- TOC entry 339 (class 1259 OID 4539185)
-- Dependencies: 2960 857 6
...
--
-- TOC entry 340 (class 1259 OID 4539190)
-- Dependencies: 2961 6
...
--
-- TOC entry 344 (class 1259 OID 4539209)
-- Dependencies: 2965 6
-- Name: vista_contratorec; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_contratorec AS
...
--
-- TOC entry 345 (class 1259 OID 4539214)
-- Dependencies: 2966 6
-- Name: vista_contratoser; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_contratoser AS
    SELECT contrato_servicio.id_cont_serv, contrato_servicio.id_serv, contrato_servicio.id_contrato, contrato_servicio.fecha_inst, contrato_servicio.cant_serv, contrato_servicio.status_con_ser, servicios.id_tipo_servicio, servicios.nombre_servicio, servicios.status_serv, tipo_servicio.tipo_servicio, tipo_servicio.status_servicio, tipo_servicio.id_franq, franquicia.nombre_franq, tarifa_servicio.id_tar_ser, tarifa_servicio.fecha_tar_ser, tarifa_servicio.status_tarifa_ser, tarifa_servicio.tarifa_ser, contrato.costo_dif_men, contrato.nro_contrato, persona.cedula AS cedulacli, persona.nombre AS nombrecli, persona.apellido AS apellidocli, servicios.tipo_costo, contrato_servicio.costo_cobro, contrato.id_calle, calle.id_sector, calle.nombre_calle, sector.id_zona, sector.nombre_sector, zona.nombre_zona, contrato.status_contrato FROM contrato_servicio, tarifa_servicio, tipo_servicio, servicios, franquicia, contrato, cliente, persona, calle, sector, zona WHERE (((((((((((contrato_servicio.id_serv = servicios.id_serv) AND (tarifa_servicio.id_serv = servicios.id_serv)) AND (servicios.id_tipo_servicio = tipo_servicio.id_tipo_servicio)) AND (tipo_servicio.id_franq = franquicia.id_franq)) AND (contrato_servicio.id_contrato = contrato.id_contrato)) AND (tarifa_servicio.status_tarifa_ser = 'ACTIVO'::bpchar)) AND (persona.id_persona = cliente.id_persona)) AND (contrato.cli_id_persona = cliente.id_persona)) AND (contrato.id_calle = calle.id_calle)) AND (calle.id_sector = sector.id_sector)) AND (sector.id_zona = zona.id_zona)) ORDER BY contrato_servicio.id_cont_serv;


ALTER TABLE public.vista_contratoser OWNER TO postgres;

--
-- TOC entry 346 (class 1259 OID 4539219)
-- Dependencies: 2967 6
...
--
-- TOC entry 347 (class 1259 OID 4539224)
-- Dependencies: 2968 6
...
--
-- TOC entry 348 (class 1259 OID 4539228)
-- Dependencies: 2969 6
...
--
-- TOC entry 349 (class 1259 OID 4539232)
-- Dependencies: 2970 6
...
--
-- TOC entry 350 (class 1259 OID 4539237)
-- Dependencies: 2971 6
-- Name: vista_edificio; Type: VIEW; Schema: public; Owner: postgres
--
P VIEW vista_edificio;

CREATE OR REPLACE VIEW vista_edificio AS 
 SELECT edificio.id_edif, edificio.edificio, sector.id_sector, sector.nombre_sector, zona.id_zona, zona.nombre_zona, ciudad.id_ciudad, ciudad.id_mun, ciudad.nombre_ciudad, ciudad.status_ciudad, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, sector.id_franq, estado.nombre_esta, estado.status_esta, franquicia.nombre_franq
   FROM edificio
    JOIN sector ON edificio.id_sector = sector.id_sector
   JOIN zona ON sector.id_zona = zona.id_zona
   JOIN ciudad ON zona.id_ciudad = ciudad.id_ciudad
   JOIN municipio ON ciudad.id_mun = municipio.id_mun
   JOIN estado ON municipio.id_esta = estado.id_esta
...
--
-- TOC entry 428 (class 1259 OID 4566116)
-- Dependencies: 3035 6
...
--
-- TOC entry 353 (class 1259 OID 4539251)
-- Dependencies: 2974 6
-- Name: vista_estado; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- TOC entry 355 (class 1259 OID 4539259)
-- Dependencies: 2976 6
...
--
-- TOC entry 356 (class 1259 OID 4539263)
-- Dependencies: 2977 6
...
--
-- TOC entry 357 (class 1259 OID 4539267)
-- Dependencies: 2978 6
...
--
-- TOC entry 358 (class 1259 OID 4539271)
-- Dependencies: 2979 6
...
--
-- TOC entry 429 (class 1259 OID 4566136)
-- Dependencies: 3036 6
...
--
-- TOC entry 359 (class 1259 OID 4539275)
-- Dependencies: 2980 6
...
--
-- TOC entry 360 (class 1259 OID 4539280)
-- Dependencies: 2981 6
...
--
-- TOC entry 361 (class 1259 OID 4539285)
-- Dependencies: 2982 6
-- Name: vista_materiales_orden; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_materiales_orden AS
...
--
-- TOC entry 362 (class 1259 OID 4539290)
-- Dependencies: 2983 6
-- Name: vista_materiales_prov; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_materiales_prov AS
...
--
-- TOC entry 363 (class 1259 OID 4539295)
-- Dependencies: 2984 6
-- Name: vista_materiales_unid; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_materiales_unid AS
...
--
-- TOC entry 364 (class 1259 OID 4539300)
-- Dependencies: 2985 6
-- Name: vista_materialesuniinv; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_materialesuniinv AS
...
--
-- TOC entry 365 (class 1259 OID 4539305)
-- Dependencies: 2986 6
-- Name: vista_matpadre; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_matpadre AS
...
--
-- TOC entry 366 (class 1259 OID 4539309)
-- Dependencies: 2987 6
-- Name: vista_matpadre_und; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_matpadre_und AS
...
--
-- TOC entry 367 (class 1259 OID 4539313)
-- Dependencies: 2988 6
-- Name: vista_matped; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_matped AS
...
--
-- TOC entry 368 (class 1259 OID 4539318)
-- Dependencies: 2989 6
-- Name: vista_matped_und; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_matped_und AS
...
--
-- TOC entry 425 (class 1259 OID 4554203)
-- Dependencies: 3034 6
...
--
-- TOC entry 369 (class 1259 OID 4539327)
-- Dependencies: 2990 6
-- Name: vista_mov_mat_o; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_mov_mat_o AS
...
--
-- TOC entry 370 (class 1259 OID 4539332)
-- Dependencies: 2991 6
-- Name: vista_mov_materiales; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_mov_materiales AS
...
--
-- TOC entry 371 (class 1259 OID 4539337)
-- Dependencies: 2992 6
-- Name: vista_movimiento_mov_mat; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_movimiento_mov_mat AS
...
--
-- TOC entry 372 (class 1259 OID 4539342)
-- Dependencies: 2993 6
-- Name: vista_movimiento_mov_mat_uni; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_movimiento_mov_mat_uni AS
...
--
-- TOC entry 373 (class 1259 OID 4539347)
-- Dependencies: 2994 6
-- Name: vista_municipio; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_municipio AS
    SELECT municipio.id_mun, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, estado.nombre_esta, estado.status_esta 
    FROM  municipio
    join  estado on municipio.id_esta = estado.id_esta
     ORDER BY municipio.id_mun;

ALTER TABLE public.vista_municipio OWNER TO postgres;

--
-- TOC entry 374 (class 1259 OID 4539351)
-- Dependencies: 2995 6
...
--
-- TOC entry 375 (class 1259 OID 4539355)
-- Dependencies: 2996 6
...
--
-- TOC entry 376 (class 1259 OID 4539360)
-- Dependencies: 2997 6
...
--
-- TOC entry 377 (class 1259 OID 4539365)
-- Dependencies: 2998 6
-- Name: vista_orden; Type: VIEW; Schema: public; Owner: postgres
--
...
--
-- TOC entry 378 (class 1259 OID 4539370)
-- Dependencies: 2999 6
-- Name: vista_orden_imp; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_orden_imp AS
...
--
-- TOC entry 379 (class 1259 OID 4539375)
-- Dependencies: 3000 6
...
--
-- TOC entry 380 (class 1259 OID 4539379)
-- Dependencies: 3001 6
...
--
-- TOC entry 381 (class 1259 OID 4539383)
-- Dependencies: 3002 6
...
--
-- TOC entry 382 (class 1259 OID 4539387)
-- Dependencies: 3003 6
...
--
-- TOC entry 383 (class 1259 OID 4539392)
-- Dependencies: 3004 6
...
--
-- TOC entry 384 (class 1259 OID 4539397)
-- Dependencies: 3005 6
...
--
-- TOC entry 385 (class 1259 OID 4539402)
-- Dependencies: 3006 6
...
--
-- TOC entry 386 (class 1259 OID 4539407)
-- Dependencies: 3007 6
...
--
-- TOC entry 387 (class 1259 OID 4539412)
-- Dependencies: 3008 6
-- Name: vista_planillainv; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_planillainv AS
...
--
-- TOC entry 388 (class 1259 OID 4539417)
-- Dependencies: 3009 6
-- Name: vista_planillamov; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_planillamov AS
...
--
-- TOC entry 389 (class 1259 OID 4539422)
-- Dependencies: 3010 6
-- Name: vista_planillaped; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_planillaped AS
...
--
-- TOC entry 390 (class 1259 OID 4539427)
-- Dependencies: 3011 6
-- Name: vista_promocion; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_promocion AS
...
--
-- TOC entry 391 (class 1259 OID 4539431)
-- Dependencies: 3012 6
...
--
-- TOC entry 392 (class 1259 OID 4539436)
-- Dependencies: 3013 6
-- Name: vista_servicios; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_servicios AS
    SELECT servicios.id_serv, servicios.id_tipo_servicio, servicios.nombre_servicio, servicios.status_serv, tipo_servicio.tipo_servicio, tipo_servicio.status_servicio, tipo_servicio.id_franq, franquicia.nombre_franq, franquicia.id_emp, franquicia.id_gf, franquicia.obser_franq, franquicia.direccion_franq, servicios.tipo_costo, servicios.tipo_paq, servicios.tarifa_esp, servicios.tipo_serv, servicios.id_cant, cant_tv.cantidad, paquete.id_paq, paquete.nombre_paq, tarifa_servicio.tarifa_ser FROM (((((servicios JOIN tipo_servicio ON ((servicios.id_tipo_servicio = tipo_servicio.id_tipo_servicio))) JOIN franquicia ON ((tipo_servicio.id_franq = franquicia.id_franq))) LEFT JOIN cant_tv ON ((servicios.id_cant = cant_tv.id_cant))) LEFT JOIN paquete ON ((servicios.id_paq = paquete.id_paq))) LEFT JOIN tarifa_servicio ON (((servicios.id_serv = tarifa_servicio.id_serv) AND (tarifa_servicio.status_tarifa_ser = 'ACTIVO'::bpchar))));


ALTER TABLE public.vista_servicios OWNER TO postgres;

--
-- TOC entry 393 (class 1259 OID 4539441)
-- Dependencies: 3014 6
...
--
-- TOC entry 394 (class 1259 OID 4539446)
-- Dependencies: 3015 6
...
--
-- TOC entry 395 (class 1259 OID 4539450)
-- Dependencies: 3016 6
...
--
-- TOC entry 396 (class 1259 OID 4539454)
-- Dependencies: 3017 6
...
--
-- TOC entry 397 (class 1259 OID 4539459)
-- Dependencies: 3018 6
-- Name: vista_reporteinventario; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_reporteinventario AS
...
--
-- TOC entry 398 (class 1259 OID 4539463)
-- Dependencies: 3019 6
-- Name: vista_reportemovimiento; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_reportemovimiento AS
...
--
-- TOC entry 399 (class 1259 OID 4539467)
-- Dependencies: 3020 6
...
--
-- TOC entry 400 (class 1259 OID 4539471)
-- Dependencies: 3021 6
-- Name: vista_sector1; Type: VIEW; Schema: public; Owner: postgres
--


CREATE OR REPLACE VIEW vista_sector1 AS 
 SELECT sector.id_sector, sector.nombre_sector, zona.id_zona, zona.nombre_zona, ciudad.id_ciudad, ciudad.id_mun, ciudad.nombre_ciudad, ciudad.status_ciudad, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, sector.id_franq, estado.nombre_esta, estado.status_esta, franquicia.nombre_franq, sector.nro_sector
   FROM sector
   JOIN zona ON sector.id_zona = zona.id_zona
   JOIN ciudad ON zona.id_ciudad = ciudad.id_ciudad
   JOIN municipio ON ciudad.id_mun = municipio.id_mun
...
--
-- TOC entry 401 (class 1259 OID 4539476)
-- Dependencies: 3022 6
...
--
-- TOC entry 402 (class 1259 OID 4539480)
-- Dependencies: 3023 6
...
--
-- TOC entry 403 (class 1259 OID 4539484)
-- Dependencies: 3024 6
...
--
-- TOC entry 404 (class 1259 OID 4539489)
-- Dependencies: 3025 6
-- Name: vista_tarifa; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_tarifa AS
    SELECT tarifa_servicio.id_tar_ser, tarifa_servicio.id_serv, tarifa_servicio.fecha_tar_ser, tarifa_servicio.hora_tar_ser, tarifa_servicio.obser_tarifa_ser, tarifa_servicio.status_tarifa_ser, tarifa_servicio.tarifa_ser, vista_servicios.id_tipo_servicio, vista_servicios.nombre_servicio, vista_servicios.status_serv, vista_servicios.tipo_servicio, vista_servicios.status_servicio, vista_servicios.id_franq, vista_servicios.nombre_franq, vista_servicios.id_emp, vista_servicios.id_gf, vista_servicios.obser_franq, vista_servicios.direccion_franq, vista_servicios.tipo_costo, vista_servicios.tarifa_esp, vista_servicios.tipo_serv FROM tarifa_servicio, vista_servicios WHERE (tarifa_servicio.id_serv = vista_servicios.id_serv);


ALTER TABLE public.vista_tarifa OWNER TO postgres;

--
-- TOC entry 405 (class 1259 OID 4539493)
-- Dependencies: 3026 6
...
--
-- TOC entry 406 (class 1259 OID 4539497)
-- Dependencies: 3027 6
-- Name: vista_tipopago; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_tipopago AS
    SELECT detalle_tipopago.id_tipo_pago, detalle_tipopago.id_pago, detalle_tipopago.banco, detalle_tipopago.numero, detalle_tipopago.monto_tp, pagos.id_caja_cob, pagos.fecha_pago, pagos.hora_pago, pagos.monto_pago, pagos.obser_pago, pagos.status_pago, pagos.nro_factura, tipo_pago.tipo_pago, caja.tipo_caja, pagos.id_contrato, caja.id_franq, caja_cobrador.id_est, pagos.monto_reten, pagos.islr, pagos.impresion FROM detalle_tipopago, pagos, tipo_pago, caja_cobrador, caja WHERE ((((detalle_tipopago.id_tipo_pago = tipo_pago.id_tipo_pago) AND (detalle_tipopago.id_pago = pagos.id_pago)) AND (pagos.id_caja_cob = caja_cobrador.id_caja_cob)) AND (caja_cobrador.id_caja = caja.id_caja)) ORDER BY pagos.fecha_pago;


ALTER TABLE public.vista_tipopago OWNER TO postgres;

--
-- TOC entry 407 (class 1259 OID 4539502)
-- Dependencies: 3028 6
-- Name: vista_tiposerv; Type: VIEW; Schema: public; Owner: postgres
--

CREATE or replace VIEW vista_tiposerv AS
    SELECT tipo_servicio.id_tipo_servicio, tipo_servicio.tipo_servicio, tipo_servicio.status_servicio, tipo_servicio.id_franq, franquicia.nombre_franq, franquicia.id_emp, franquicia.id_gf, franquicia.obser_franq, franquicia.direccion_franq FROM franquicia, tipo_servicio WHERE (tipo_servicio.id_franq = franquicia.id_franq);


ALTER TABLE public.vista_tiposerv OWNER TO postgres;

--
-- TOC entry 408 (class 1259 OID 4539506)
-- Dependencies: 3029 6
...
--
-- TOC entry 409 (class 1259 OID 4539510)
-- Dependencies: 3030 6
-- Name: vista_urb; Type: VIEW; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW vista_urb AS 
 SELECT urbanizacion.id_urb, urbanizacion.nombre_urb, sector.id_sector, sector.nombre_sector, zona.id_zona, zona.nombre_zona, ciudad.id_ciudad, ciudad.id_mun, ciudad.nombre_ciudad, ciudad.status_ciudad, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, sector.id_franq, estado.nombre_esta, estado.status_esta, franquicia.nombre_franq
   FROM  urbanizacion
  JOIN sector ON urbanizacion.id_sector = sector.id_sector
   JOIN zona ON sector.id_zona = zona.id_zona
   JOIN ciudad ON zona.id_ciudad = ciudad.id_ciudad
   JOIN municipio ON ciudad.id_mun = municipio.id_mun
   JOIN estado ON municipio.id_esta = estado.id_esta
...
--
-- TOC entry 410 (class 1259 OID 4539515)
-- Dependencies: 3031 6
...
--
-- TOC entry 411 (class 1259 OID 4539519)
-- Dependencies: 3032 6
-- Name: vista_zona1; Type: VIEW; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW vista_zona1 AS 
 SELECT zona.id_zona, zona.nombre_zona, ciudad.id_ciudad, ciudad.id_mun, ciudad.nombre_ciudad, ciudad.status_ciudad, municipio.id_esta, municipio.nombre_mun, municipio.status_mun, estado.nombre_esta, estado.status_esta, zona.nro_zona
   FROM zona
    JOIN ciudad ON zona.id_ciudad = ciudad.id_ciudad
   JOIN municipio ON ciudad.id_mun = municipio.id_mun
   JOIN estado ON municipio.id_esta = estado.id_esta
...
--
-- TOC entry 412 (class 1259 OID 4539523)
-- Dependencies: 3033 6
...
CREATE or replace VIEW vista_franq AS
...
from franquicia
join grupo_franq on franquicia.id_gf = grupo_franq.id_gf
join empresa on franquicia.id_emp = empresa.id_emp 
...
CREATE OR REPLACE VIEW vista_cont_serv AS 
 SELECT contrato_servicio.id_cont_serv, contrato_servicio.id_serv, contrato_servicio.id_contrato, contrato_servicio.fecha_inst, contrato_servicio.cant_serv, contrato_servicio.status_con_ser, servicios.id_tipo_servicio, servicios.nombre_servicio, tipo_servicio.tipo_servicio, contrato_servicio.costo_cobro, servicios.tipo_paq
   FROM contrato_servicio, tipo_servicio, servicios
  WHERE contrato_servicio.id_serv = servicios.id_serv AND servicios.id_tipo_servicio = tipo_servicio.id_tipo_servicio;
