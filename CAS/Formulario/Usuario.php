...
<form name="f1">
	<table border="1" width="420px" align="CENTER" bordercolor="" > 
		<tr>
			...
			<td>
				<input  type="text" name="login" maxlength="15" size="25"onChange="validarUsuario()" value="">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input  type="text" name="cedula" maxlength="8" size="25"onChange="validarEmp()" value="">
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td colspan="2" rowspan="1">
				...
				<div align="center">
					<input  type="button" name="registrar" value="REGISTRAR" onclick="verificar_cas('incluir','Usuario')">&nbsp;
					<input  type="button" name="modificar" value="MODIFICAR" onclick="verificar_cas('modificar','Usuario')">&nbsp;
					<input  type="button" name="eliminar" value="ELIMINAR" onclick="verificar_cas('eliminar','Usuario')">&nbsp;
