...
<form name="f1">
	<table border="1" width="420px" align="CENTER" bordercolor="" > 
		...
		<tr>
			...
			<td>
				<input  type="text" name="nombre" maxlength="20" size="25" value="" onChange="asignaNameModulo()">
		...
		<tr>
			<td colspan="2" rowspan="1">
				...
				<div align="center">
					<input  type="button" name="registrar" value="REGISTRAR" onclick="verificar_cas('incluir','Modulo')">&nbsp;
					<input  type="button" name="modificar" value="MODIFICAR" onclick="verificar_cas('modificar','Modulo')">&nbsp;
					<input  type="button" name="eliminar" value="ELIMINAR" onclick="verificar_cas('eliminar','Modulo')">&nbsp;
