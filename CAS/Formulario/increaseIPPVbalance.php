...
<BR><div class="cabe"><?php echo _("increaseIPPVbalance Smartcard");?></div>
<form name="f1" >
...
<input  type="hidden" value="" name="total">
		<tr>
			<td colspan="2" rowspan="1">
				<br>
				<div align="center">
					<input  type="button" name="registrar" value="increaseIPPVbalance" onclick="verificar_cas('increaseIPPVbalance','increaseIPPVbalance')">&nbsp;
					...
					<input  type="button" name="salir" onclick="conexionPHP_cas('formulario.php','increaseIPPVbalance')" value="<?php echo _("limpiar");?>">
				</div>
			</td>
		</tr>
		<tr>			
