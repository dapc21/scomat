...
function registrar($clase){	
	return boton("REGISTRAR","registrar",'verificar_cas(\'incluir\',\''.$clase.'\')',"button");
}
function modificar($clase){	
	return boton("MODIFICAR","modificar",'verificar_cas(\'modificar\',\''.$clase.'\')',"button");
}
function eliminar($clase){	
	return boton("ELIMINAR","eliminar",'verificar_cas(\'eliminar\',\''.$clase.'\')',"button");
}
function cancelar(){
