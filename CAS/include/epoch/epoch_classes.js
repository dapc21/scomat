...
function Epoch(name,mode,targetelement,multiselect,min,max) {
	var arg=Epoch.arguments.length;	
	...
	*/
	function calConfig() {
		...
		if(arg==6){
			self.minDate = new Date(min,0,1);
			self.maxDate = new Date(max,11,31);
		}
		else{
			self.minDate = new Date(2009,0,1);
