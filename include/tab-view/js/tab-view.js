...
************************************************************************************************************/
	...
	{
		if((claseGlobal=="pagos" || claseGlobal=="act_contrato") && tabIndex!='0' && id_contrato()==''){
			alert("Error, Debe Cargar un contrato");
		}
		else{
			//alert(":"+claseGlobal+":"+tabIndex+':');
			if(claseGlobal=="pagos" && tabIndex=='0'){
			...
			else if(claseGlobal=="pagos" && tabIndex=='1'){
			
				divDataGrid="estado"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/estadocuenta.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="pagos" && tabIndex=='2'){
				divDataGrid="historial"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/historialpago.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="pagos" && tabIndex=='3'){
				divDataGrid="comunicacion"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				conexionPHP_sms("sms.php","listadoSMSEsp",id_contrato());
			}
			else if(claseGlobal=="pagos" && tabIndex=='4'){
			...
			else if(claseGlobal=="pagos" && tabIndex=='5'){
				divDataGrid="exoneracion"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="procesos/exoneracion.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="pagos" && tabIndex=='6'){
				divDataGrid="historico"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/historicos.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			//////////////////////////CONTRATOS////////////////////////
			else if(claseGlobal=="act_contrato" && tabIndex=='0'){
				divDataGrid="cargos"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="procesos/datagrid_pagos.php?&id_contrato="+id_contrato()+"&";
			}
			else if(claseGlobal=="act_contrato" && tabIndex=='1'){
			
				divDataGrid="estado"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/estadocuenta.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="act_contrato" && tabIndex=='2'){
				divDataGrid="historial"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/historialpago.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="act_contrato" && tabIndex=='3'){
				divDataGrid="comunicacion"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				conexionPHP_sms("sms.php","listadoSMSEsp",id_contrato());
			}
			
			else if(claseGlobal=="act_contrato" && tabIndex=='4'){
				divDataGrid="vitacora"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="procesos/datagrid_info_adic.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="act_contrato" && tabIndex=='5'){
				divDataGrid="exoneracion"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="procesos/exoneracion.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if(claseGlobal=="act_contrato" && tabIndex=='6'){
				divDataGrid="historico"; params = ''; tblpage = ''; tblorder = ''; tblfilter = '';
				archivoDataGrid="reportes/historicos.php?&id_contrato="+id_contrato()+"&";
				updateTable();
			}
			else if((claseGlobal=="pagos" || claseGlobal=="act_contrato") && (tabIndex=='5' || tabIndex=='6'|| tabIndex=='7')){
				tabIndex='2';
			}
		/*
		  var pareja=false;
		  if(estadoCivilGlobal=="Casado" || estadoCivilGlobal=="Concubinato"){
					if(document.f2.id_solicitante.value==''){
						pareja=false;
					}
					else{
						pareja=true;
		  ...
		  if(tabIndex=='4' && (pareja==false || document.f3.id_solicitante.value=='' || document.f4.id_persona.value=='' || document.f4.id_persona.value=='')){
			alert('Error, para realizar la solicitud debe completar todos los datos');
		  }
		  else{
		  */
			//inicialTab(tabIndex);
			...
			if(activeTabIndex[parentId]>=0){
				...
				img.src = 'include/tab-view/images/tab_right_inactive.gif';
			...
			img.src = 'include/tab-view/images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = 'include/tab-view/images/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = 'include/tab-view/images/close.gif';
