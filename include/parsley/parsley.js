...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    integer:      "Este valor debe ser un entero válido.",
  ...
  range:          "Este valor debe estar entre %s and %s.",
  minlength:      "Este valor es demasiado corta Debe tener %s caracteres o más.",
  maxlength:      "Este valor es demasiado largo Debe tener %s caracteres o menos.",
  length:         "Esta longitud valor no es válido. Debe estar entre %s and %s caracteres.",
  mincheck:       "Usted debe seleccionar al menos %s opciones.",
  maxcheck:       "Usted debe seleccionar máximo %s opciones.",
