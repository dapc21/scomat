...
class PDF extends FPDF
{
	...
	function Cuerpo($acceso,$id_contrato)
	{
		...
		$acceso->objeto->ejecutarSql("select *from parametros where id_param='17' and id_franq='1'");
		$row=row($acceso);
		$telefono=trim($row['valor_param']);
$this->SetX(60);
		
		$this->MultiCell(145,5,nombre_empresa()." ".date('d/m/Y h:m:i')."
"."RIF: ".tipo_serv()." $telefono","0","R");
		...
		$this->Image("../imagenes/$logo",8,5,$ancho_logo);
		$this->Ln();
		
		
		$this->SetX(60);
		$this->SetFont('Arial','',18);
		$this->MultiCell(145,5,"CONTRATO DE SERVICIO",'0','R');		    
		$this->SetX(60);
		
		$this->SetTextColor(255,0,0);
		$this->SetFont('Arial','B',16);
		$this->MultiCell(145,5,"Nº $nro_contrato",'0','R');
		...
		$this->Cell(195,6,"DATOS DE EL SUSCRIPTOR","1",0,"C",'1');
		$this->SetTextColor(0,0,0);
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(195,6,"Nombres: $nombrecli","1",0,"J");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(98,6,"Calle: $nombre_calle","1",0,"J");
		
		$this->Cell(97,6,"Nº. de Casa : $numero_casa","1",0,"J");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(50,6,"SERVICIOS ","1",0,"J");
		$this->Cell(50,6,"PROMOCION ","1",0,"C");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(50,5,"Instalación","1",0,"J");
		$this->Cell(50,5,"","1",0,"J");
		$this->Cell(30,5,"1","1",0,"C");
		$this->Cell(30,5,"$costo_inst","1",0,"C");
		$this->Cell(35,5,"$costo_inst","1",0,"C");
		//$this->Cell(35,5,"$costo_contrato","1",0,"C"); el costo del contrato me toma la mensualidad y no el costo de instalación 
	
		$this->Ln();
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(50,5,"Tomas Adicionales","1",0,"J");
		$this->Cell(50,5,"","1",0,"J");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(50,5,"Dedodificador","1",0,"J");
		$this->Cell(50,5,"","1",0,"J");
		$this->Cell(30,5,"","1",0,"C");
		$this->Cell(30,5,"","1",0,"C");
		$this->Cell(35,5,"","1",0,"C");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(50,5,"Mes Adelantado","1",0,"J");
		$this->Cell(50,5,"","1",0,"J");
		$this->Cell(30,5,"","1",0,"C");
		$this->Cell(30,5,"","1",0,"C");
		$this->Cell(35,5,"","1",0,"C");
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(35,5,"$costo_inst","LRT",0,"C");
		...
		$this->SetFont('times','',12);
		$this->SetX(10);
		$this->Cell(195,6,"Observaciones: $observacion","1",0,"J");
		...
		$this->SetFillColor(76,136,206);
		$this->SetTextColor(255,255,255);
		$this->Cell(195,6,"FORMAS DE PAGO","1",0,"C",'1');
		$this->SetTextColor(0,0,0);
