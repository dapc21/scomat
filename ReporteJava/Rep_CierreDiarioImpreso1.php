...
class PDF extends JavaPrint
{
	...
	function TituloCampos()
	{
		...
		$w=array(10,38,18,50,22,16,16);
		$header=array(strtoupper(_('nro')),strtoupper(_('punto de cobro')),strtoupper(_('monto')),strtoupper(_('cobrador')),strtoupper(_('fecha')),strtoupper(_('hora a.')),strtoupper(_('hora c.')));
		$this->SetFont('Arial','B',9);
		$this->SetX(15);
		for($k=0;$k<count($header);$k++)
			$this->Cell($w[$k],7,$header[$k],0,0,'J',0);
		$this->Ln();
		return $w;
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->Ln();
			...
			$this->Ln();
		$this->SetX(15);
		$this->Cell(40,6,strtoupper(_('detalle de los puntos de cobros')),"0",0,"L");
		$this->Ln();
		$w=$this->TituloCampos();
		...
		while ($row=row($acceso))
		{
			...
			$this->Cell($w[1],6,substr(utf8_decode(trim($row["nombre_caja"])), 0,20),"",0,"J",$fill);
