...
ORDER BY pagos.fecha_pago, pagos.hora_pago;";
		...
		$cont=lectura($acceso,"SELECT nombre_zona,nombre_sector,nombre_calle,numero_casa,telefono,direc_adicional,tipo_cliente,edificio,numero_piso,taps FROM vista_contrato where id_contrato='$id_contrato' LIMIT 1 offset 0");
...
//		echo "<br><br>SELECT tipo_pago.tipo_pago, detalle_tipopago.banco,detalle_tipopago.numero FROM tipo_pago,detalle_tipopago where id_pago='$id_pago' and detalle_tipopago.id_tipo_pago = tipo_pago.id_tipo_pago";
	...
	if($taps=='C'){
		...
		$this->add("CEDULA: $cedulacli",$x2,$alto);
		...
		$this->add("precinto: ". $etiqueta,$x2,$alto);
		$this->add("precinto: $etiqueta",$y2,$alto);
