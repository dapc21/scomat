	...
	function Header()
        {
                ...
                $this->Cell(15,5,strtoupper(_('fecha')).": ",0,0,'L');
        ...
        */
        ...
        function estado_cuenta_con($acceso,$id_contrato,$titulo,$sety)
        {
                ...
                if($row=row($acceso))
                {
                        ...
                        $dir ="$nombre_mun, $nombre_zona, $nombre_sector, $urbanizacion,  $nombre_calle $edificio,  $numero_casa, $numero_piso ; REF. $direc_adicional";
