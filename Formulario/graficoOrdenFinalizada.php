...
$_SESSION["titulo_estadistico"] = 'ÓRDENES FINALIZADAS';
...
<form role="form" name="f1" id="form_grafico_orden_finalizada" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Órdenes de Servicios Finalizadas</h3></div>
	<section class="panel">		
			...
			<div class="panel-body">	
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
						...
						<select class="form-control" name="tipo_grafico" id="tipo_grafico" onchange="">
		  ...
		  <div class="row">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="barra">
					  <header class="panel-heading">
						  Estadísticas de Barras - Órdenes de Servicios Finalizadas
					  </header>
					  <div class="panel-body">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="linea">
					  <header class="panel-heading">
						  Estadísticas de Líneas de Tiempo - Órdenes de Servicios Finalizadas
					  </header>
					  <div class="panel-body">
		  ...
		  <div class="row">
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="area">
					  <header class="panel-heading">
						  Estadísticas de Área - Órdenes de Servicios Finalizadas
					  </header>
					  <div class="panel-body">
