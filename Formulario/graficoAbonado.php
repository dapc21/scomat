...
$_SESSION["titulo_estadistico"] = 'ABONADOS';
...
<form role="form" name="f1" id="form_grafico_abonado" >
	
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Abonados</h3></div>
	<section class="panel">		
		  ...
		  <div class="row">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="barra">
					  <header class="panel-heading">
						  Estadísticas de Barras - Abonados
					  </header>
					  <div class="panel-body">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="linea">
					  <header class="panel-heading">
						  Estadísticas de Líneas de Tiempo - Abonados
					  </header>
					  <div class="panel-body">
