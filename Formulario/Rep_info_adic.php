...
<form role="form" name="f1" id="rep_info_adic" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MEN? -->
	<div class="border-head"><h3>Reporte de Llamadas</h3></div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="form-group col-lg-3 col-md-6 col-sm-12 col-xs-12">
							...
							<select class="form-control" name="login" id="login">
								<?php echo respon_info_adic($acceso);?>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-btn col-lg-3 col-md-6 col-sm-12 col-xs-12 pull-left">								
								<button class="btn btn-info" type="button" name="buscar" value="<?php echo _("buscar");?>" onclick="buscar_info_adic()"><i class="fa fa-search"></i> Buscar</button>																						
							</div>	
						</div>	
		...
		<section class="panel">		
			...
			<div class="panel-body">
				...
				<div class="form-btn col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
					...
					<button class="btn btn-success" type="button" type="<?php echo $obj->in;?>" name="registrarf" value="<?php echo _("descargar reporte individual");?>" onclick="DescargarRep_info_adic()"><i class="fa fa-download"></i> descargar reporte individual</button>
					<input  class="form-control" type="hidden" name="registrarf" value="<?php echo _("todos los cobradores");?>" onclick="DescargarRep_libro_cobradorTodos()">&nbsp;
