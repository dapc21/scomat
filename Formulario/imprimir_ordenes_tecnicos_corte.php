...
<form role="form" name="f1" id="imprimir_ordenes_tecnicos_corte" >
	...
	<div class="border-head"><h3>imprimir listado para cortes</h3></div>
	
	<!-- ?EA DE PANEL O PANELES -->
	<section class="panel" id="tabla-orden-tecnico-corte">
	
		<!-- CABECERA O T?ULO DEL PANEL (EQUIVALENTE A UN FIELDSET SIN SERLO) -->
		<header class="panel-heading">Listados de Corte</header>
			<div class="panel-body">

				<input class="form-control" type="button" name="registrar" value="<?php echo _("imprimir HTML");?>" onclick="imprimirhtml()">&nbsp;
				<input class="form-control" type="button" name="modificar" value="<?php echo _("imprimir pdf");?>" onclick="imprimirpdf()">&nbsp;
