...
$_SESSION["titulo_estadistico"] = 'INGRESOS Y DEUDAS MENSUALES';
...
<form role="form" name="f1" id="form_grafico_ingreso_deuda_mes" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Ingresos y Deudas (Mensuales)</h3></div>
	<section class="panel">		
		  ...
		  <div class="row">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="barra">
					  <header class="panel-heading">
						  Estadísticas de Barras - Ingresos y Deudas Mensuales
					  </header>
					  <div class="panel-body">
			  ...
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="linea">
					  <header class="panel-heading">
						  Estadísticas de Líneas de Tiempo - Ingresos y Deudas Mensuales
					  </header>
					  <div class="panel-body">
		  ...
		  <div class="row">
			  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <section class="panel" id="area">
					  <header class="panel-heading">
						  Estadísticas de Área - Ingresos y Deudas Mensuales
					  </header>
					  <div class="panel-body">
