...
$_SESSION["titulo_estadistico"] = 'ABONADOS MENSUALES';
...
<form role="form" name="f1" id="form_grafico_abonado_mes" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Abonados (Mensuales)</h3></div>
	<section class="panel">		
