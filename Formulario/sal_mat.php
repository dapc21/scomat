...
$obj=new Usuario('','','','','');
if($obj->permisoModulo($acceso,strtoupper('SAL_MAT')))
{
?>
<BR><div class="cabe">SALIDA de materiales</div>
<form name="f1" >
...
<table border="0" width="97%" align="CENTER"> 
	...
	<table border="0" width="97%" align="CENTER" bordercolor="" > 
		...
		<tr>
			...
			<td>
				<input  disabled type="text" name="precio" maxlength="10" size="15" value="" >
			</td>
		</tr>
	...
	<table border="0" width="97%" align="CENTER" bordercolor="" > 
		...
		<input  type="hidden" name="tipo_ent_sal" maxlength="10" size="15" value="Salida" >
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input  type="text" name="cant_ent_sal" maxlength="4" size="15" value="" onchange="verificaStock()">
			</td>
		...
		<tr>
			<td colspan="2" rowspan="1">
				...
				<div align="center">
					...
					<input  type="button" name="salir" onclick="conexionPHP('formulario.php','sal_mat')" value="LIMPIAR">
				</div>
			</td>
		</tr>
<tr>
  <td>
	<br>
	<fieldset >
		<legend >SALIDAS RECIENTES</legend>
