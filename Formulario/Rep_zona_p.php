...
<BR><div class="cabe"><?php echo _("reporte de penetracion por zonas");?></div>
<form name="f1" >
	<table border="0" width="100%" align="CENTER"> 
		...
		<tr>
			<td colspan="2">
				...
				<div align="center">
					<input  type="button" name="registrar" value="<?php echo _("imprimir reporte");?>" onclick="ImprimirRep_zona_p()">&nbsp;
