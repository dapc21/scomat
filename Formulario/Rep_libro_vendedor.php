...
$obj=new Usuario('','','','','');
if($obj->permisoModulo($acceso,strtoupper('REP_VENDEDOR')))
{
?>
...
<form role="form" name="f1" id="Rep_libro_vendedor" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MEN? -->
	<div class="border-head"><h3>reporte de cobranza por vendedor</h3></div>
	
		<!-- ?EA DE PANEL O PANELES -->
		<section class="panel">
		
			<!-- CABECERA O T?ULO DEL PANEL (EQUIVALENTE A UN FIELDSET SIN SERLO) -->
			<header class="panel-heading">contratos registrados</header>
				<div class="panel-body">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="form-group col-lg-2 col-md-6 col-sm-12 col-xs-12">
							...
							<input class="form-control" type="text" name="com" id="com" maxlength="5" value="" >	
						...
						<div class="form-group">
							...
							<div class="form-btn col-lg-3 col-md-6 col-sm-12 col-xs-12 pull-left">								
								<button class="btn btn-success" type="button" name="buscar" value="<?php echo _("buscar");?>" onclick="buscar_libro_vendedor()"><i class="fa fa-search"></i> Buscar</button>																						
							</div>	
						</div>	
	...
	<section class="panel">		
			...
			<div class="panel-body">
					...
					<div class="form-btn col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
						<input class="form-control" type="hidden" name="registrar" value="<?php echo _("imprimir reporte");?>" onclick="ImprimirRep_libro_vendedor()">&nbsp;						
						<button class="btn btn-info" type="button" type="<?php echo $obj->in;?>" name="registrarf" value="<?php echo _("todos los cobradores");?>" onclick="DescargarRep_libro_vendedor()"><i class="fa fa-download"></i> descargar reporte</button>
