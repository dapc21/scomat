...
$_SESSION["titulo_estadistico"] = 'INGRESOS Y DEUDAS';
...
<form role="form" name="f1" id="form_grafico_ingreso_deuda_a" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Ingresos y Deudas Anuales</h3></div>
	<section class="panel">		
