		...
		<tr>
			<td colspan="4" rowspan="1">
				...
				<div align="center">
					...
					<input  type="button" name="salir" onclick="conexionPHP('formulario.php','antes_cirre_diario1')" value="ACTUALIZAR CONSULTA">
				</div>
			</td>
		</tr>
...
';
  ?>
	...
	<br>
	<fieldset >
		<legend ><?php echo _("detalle de los puntos de cobros");?></legend>
