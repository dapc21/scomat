...
$_SESSION["titulo_estadistico"] = 'ÓRDENES FINALIZADAS MENSUALES';
...
<form role="form" name="f1" id="form_grafico_orden_finalizada_mes" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Órdenes de Servicios Finalizadas (Mensuales)</h3></div>
	<section class="panel">		
