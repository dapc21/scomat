...
$_SESSION["titulo_estadistico"] = 'ÓRDENES ASIGNADAS';
...
<form role="form" name="f1" id="form_grafico_orden_asignada" >
		
	<!-- TITULO DEL FORMULARIO (DEBE SER IGUAL AL NOMBRE DEL ITEM DEL MENÚ) -->
	<div class="border-head"><h3>Gráficas Estadísticas de Órdenes de Servicios Asignadas</h3></div>
	<section class="panel">		
