function areaWysiwyg(valor){
//	alert('entro a reemplazar:'+valor);
	valor= valor.replace(/=/g, "|||");
	//valor= str_replace('=', '|||',valor);
	valor= valor.replace(/&/g, "|-|");
//	valor= str_replace('&', '|-|',valor);
//	alert('ya reemplazo:'+valor);
	return valor;
}
...
/*
function converHTML(cad){
	var trad =new Array("Á","É","Í","Ó","Ú","á","é","í","ó","ú","Ñ","ñ");
	var tradu =new Array("&Aacute;","&Eacute;","&Iacute;","&Oacute;","&Uacute;","&aacute;","&eacute;","&iacute;","&oacute;","&uacute;","&Ntilde;","&ntilde;");
	var cade='';
	var valor=false;
	for(i=0;i<cad.length;i++){
		valor=false;
		for(j=0;j<trad.length;j++)
		{
			if(trad[j]==cad[i])
			{
				cade=cade+tradu[j];
...
function validaTextArea(){
	...
	{
		alert('Error, debe escribir una descripcion en el Editor Wysiwyg');
...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "include/editor/images/";
		
		// Popups Directory
		this.PopupsDir = "include/editor/popups/";
		
		// CSS Directory File
		this.CSSFile = "include/editor/styles/wysiwyg.css";		
	...
	"strikethrough":  ['Strikethrough',        'Rayado',      	'strikethrough.gif',      'strikethrough_on.gif'],
	"seperator":      ['',                     '',                   	'seperator.gif',          'seperator.gif'],
	"subscript":      ['Subscript',            'Sub&iacute;ndice',          	'subscript.gif',          'subscript_on.gif'],
	"superscript":    ['Superscript',          'Super&iacute;ndice',        	'superscript.gif',        'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Alinear a la Izquierda',        	'justify_left.gif',       'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Centrar',      	'justify_center.gif',     'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Alinear a la Derecha',       	'justify_right.gif',      'justify_right_on.gif'],
	"justifyfull": 	  ['Justifyfull', 		   'Justificar', 			'justify_justify.gif', 	  'justify_justify_on.gif'], 
	"unorderedlist":  ['InsertUnorderedList',  'Insertar Numeraci&oacute;n',	'list_unordered.gif',     'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Insertar Viñetas',  	'list_ordered.gif',       'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Reducir Sangría',            	'indent_left.gif',        'indent_left_on.gif'],
	"indent":         ['Indent',               'Aunmentar Sangría',             	'indent_right.gif',       'indent_right_on.gif'],
	"forecolor":      ['ForeColor',            'Color de Fuente',          	'forecolor.gif',          'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Color de Relleno',          	'backcolor.gif',          'backcolor_on.gif'],
	"undo":           ['Undo',                 'Deshacer',               	'undo.gif',               'undo_on.gif'],
	"redo":           ['Redo',                 'Rehacer',               	'redo.gif',               'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Insertar Tabla',        	'insert_table.gif',       'insert_table_on.gif'],
	"createlink":     ['CreateLink',           'Crear Link',         	'insert_hyperlink.gif',   'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'Ver Codigo',         	'view_source.gif',        'view_source_on.gif'],
	"viewText":       ['ViewText',             'Ver Texto',           	'view_text.gif',          'view_text_on.gif'],
	...
	execCommand: function(n, cmd, value){	
		...
		switch(cmd) {
			...
			case "Preview":
				//alert("entro a Preview");
				this.guardarCodigo(n);
