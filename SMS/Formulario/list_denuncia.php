...
<form role="form" name="f1" id="form_lista_falla" >
	...
	<div class="border-head"><h3>Listado de Denuncias Reportadas por Revisar</h3></div>
	...
	<section class="panel">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<select class="form-control" name="status_list" id="status_list" onchange="buscar_list_denuncia();">
			...
			<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<select class="form-control" name="marcar_como" id="marcar_como" onchange="marcar_list_denuncia();">
	...
	<section class="panel">		
		<div class="panel-body">
			<div class="form-btn col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
				<button class="btn btn-success" type="button" name="registrar" value="<?php echo _("procesar denuncia");?>" onclick="procesar_list_denuncia()"><i class="glyphicon glyphicon-ok"></i> Procesar Denuncia</button>
				...
				<button class="btn btn-info" type="button" name="Resetear" onclick="javascript:conexionPHP_sms('formulario.php','list_denuncia')" value="<?php echo _("limpiar");?>"><i class="glyphicon glyphicon-repeat"></i>Limpiar</button>
	...
	<section class="panel">		
		...
		<header class="panel-heading">Datos de las Denuncias Registradas</header>
