<?php
include_once "Clases/facturacion.php";

$acceso->objeto->ejecutarSql("BEGIN;");


$id_contrato='XH00001731';
$id_pago='AA0000015655';
//$id_contrato='XH00032375';

$dias_prorrateo=21;
$fecha='2015-05-01';
$monto_prorrateo=261.29;
...
$obj=new facturacion($dat);
//$obj->registrar_prorrateo_corte($acceso,$dias_prorrateo);
$obj->registrar_prorrateo_reconexion($acceso,$dias_prorrateo);



if($resp=$acceso->objeto->error()!=''){
		echo "<br>".$acceso->objeto->error();
