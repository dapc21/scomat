...
$x->setQuery("id_all,ubica_all,fecha_all,(nombre || ' ' || apellido) as responsable,
...
(SELECT count(*) as cant FROM  asig_lla_cli,llamadas,detalle_resp where asig_lla_cli.id_lla=llamadas.id_lla and asig_lla_cli.id_all=asigna_llamada.id_all and llamadas.id_drl=detalle_resp.id_drl AND status_lc='LLAMADO' and id_trl='BG002') as llamadas_no_atend,
...
","asigna_llamada,personausuario","id_all","asigna_llamada.login_resp=personausuario.login and fecha_all between '$desde' and '$hasta'");
