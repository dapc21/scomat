...
$x->setQuery("id_es,codigo_es,ubicacion,nombre_modelo,sistema,ver_serv_sist_equipo(id_es) as paquetes", "vista_equipo_sistema","id_es","id_contrato='$id_contrato'");
$x->hideColumn('id_es');
...
$x->addStandardControl(EyeDataGrid::STDCTRL_EDIT, "");
$x->addRowSelect("buscar_equipo_codigo_es('%codigo_es%');");
