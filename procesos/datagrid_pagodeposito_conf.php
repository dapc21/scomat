...
$where="id_pd <>'' and status_pd='$status_pd' ";
if($desde!='' && $hasta!=''){
...
if($banco!='' && $banco!=''){
	$where =$where." and  banco='$banco'";
}
//echo "$where";

//crea la consulta SQL 
//campos, tabla, campo clave
$x->setQuery("id_pd, nro_contrato, nombre || ' ' || apellido as cliente, fecha_reg, fecha_dep, banco, numero_ref, monto_dep,tipo_dt,cedula_titular, nombre_franq,login_reg,obser_p", "vista_pagodeposito","id_pd","$where");
$x->hideColumn('id_pd');
...
$x->addRowSelect("traerpagodeposito_mod('%id_pd%','%numero_ref%','%monto_dep%')");
