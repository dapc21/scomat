...
$x->addStandardControl(EyeDataGrid::STDCTRL_EDIT, "buscar_id_cd_inst('%id_cd%');");
$x->addStandardControl(EyeDataGrid::STDCTRL_DELETE, "eliminarcargar_deuda_inst('%id_cd%','%id_serv%');");
$x->hideFooter(true);
$x->printTable();
...
<div align="right">
	<div class="form-group col-lg-3 col-md-5 col-sm-6 col-xs-12">
		<div class="input-group">
			<span id="saldo" class="input-group-addon">TOTAL INSTALACION</span>
