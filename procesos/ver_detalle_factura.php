...
//echo$id_pago;
$x->setQuery("nombre_servicio,fecha_inst,cant_serv,costo_cobro,descu,costo_cobro as total,pagado, (((cant_serv*costo_cobro)-descu)-pagado) as deuda","vista_contratodeu","","id_pago='$id_pago'");
