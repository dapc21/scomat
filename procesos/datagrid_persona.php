...
$x->setQuery("id_persona,cedula,nombre,apellido,telefono", "persona","id_persona","");
...
$x->addRowSelect("conexionPHP('validarExistencia.php','1=@persona','id_persona=@%id_persona%');window.location.replace('#');");
/*
