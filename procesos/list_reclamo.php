...
$x->setQuery("id_sms,nro_contrato,nombre,apellido,fecha_sms,mensaje_sms", "vista_sms","id_sms"," tipo_sms='DELIVER' and tipo_list='RECLAMO' and status_list='POR REVISAR'");
$x->hideColumn('id_sms');
