...
$x->setQuery("id_ent_sal,numero_mat,nombre_mat,cant_existencia,cant_ent_sal,fecha_ent_sal,tipo_ent_sal", "vista_materiales","id_ent_sal","tipo_ent_sal='SALIDA' $where");
