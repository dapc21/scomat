...
$x->setQuery("id_es,codigo_es,sistema,ver_serv_sist_equipo(id_es) as paquetes", "vista_equipo_sistema","id_es","id_contrato='$id_contrato'");
$x->hideColumn('id_es');
...
//$x->addStandardControl(EyeDataGrid::STDCTRL_EDIT, "buscar_equipo_codigo_es('%codigo_es%')");
