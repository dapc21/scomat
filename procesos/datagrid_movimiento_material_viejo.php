...
$x->setQuery("id_mov_mat,id_stock,id_res,id_tipo_mov,id_mat,id_alm_mov,id_gt,id_enc,ref_mov,mot_mov,nombre_tipo_mov,cant_mov_mat,nombre_uni_sal,nombre_uni_ent,nombre_mat,stock,stock_min,nombre_alm,codigo_mat", "vista_movimiento_material","id_mov_mat","$consult");
...
$x->hideColumn('stock');
$x->setColumnHeader('id_mov_mat', 'id Mov.');
