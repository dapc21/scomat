...
function llamarGrafico(){
	location.href="est_m_c_zona.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_zona="+document.f1.id_zona.value+"&anio="+document.f1.anio.value+"&";
}
function imprimirGrafico(){
	post_image(false);
	location.href="est_m_c_zona_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_zona="+document.f1.id_zona.value+"&anio="+document.f1.anio.value+"&";
