...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->MultiCell(190,7,utf8_decode("ESTADISTICAS ANUALES DE $this->nombre_det_orden POR FRANQUICIA"),'0','C');
	...
	function Cuerpo($acceso,$inicio_a,$fin_a,$id_det_orden,$id_tipo_orden)
	{
		
		$this->SetXY(20,30);
		$this->Cell(190,6,'AÑO INICIO: '.$inicio_a.'          AÑO FIN: '.$fin_a,"0",0,"L");
...
$pdf->AddPage();
$pdf->Cuerpo($acceso,$inicio_a,$fin_a,$id_det_orden,$id_tipo_orden);
