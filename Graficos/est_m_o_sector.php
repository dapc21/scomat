...
function llamarGrafico(){
		location.href="est_m_o_sector.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&id_det_orden="+document.f1.id_det_orden.value+"&id_tipo_orden="+document.f1.id_tipo_orden.value+"&id_sector="+document.f1.id_sector.value+"&";
}

function imprimirGrafico(){
	post_image(false);
		location.href="est_m_o_sector_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&id_det_orden="+document.f1.id_det_orden.value+"&id_tipo_orden="+document.f1.id_tipo_orden.value+"&id_sector="+document.f1.id_sector.value+"&";
}
</script>
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS MENSUALES DE <?php echo strtoupper(utf8_decode($nombre_det_orden));?> POR SECTOR</div>
		</td>
	</tr>
	<tr>
