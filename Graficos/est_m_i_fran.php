...
//echo "SELECT sum(costo_cobro) as deuda FROM contrato_servicio_deuda where fecha_inst between '$fec_ini' and '$fec_fin' and status_con_ser='DEUDA'";
...
function llamarGrafico(){
	location.href="est_m_i_fran.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&id_franq="+document.f1.id_franq.value+"&";
	
}

function imprimirGrafico(){
	post_image(false);
	location.href="est_m_i_fran_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&";
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS MENSUALES DE INGRESOS Y DEUDAS POR FRANQUICIAS</div>
		</td>
	</tr>
	<tr>
			<td colspan="2" ALIGN="CENTER" class="estilocabeN">
				<table border="0" width="760px" align="center" cellspacing="2" cellpadding="2"> 
					...
					<tr>
						...
						<td class="estilocabeN">
							<select name="id_franq" id="id_franq" onchange="llamarGrafico()" style="width: 150px;">
