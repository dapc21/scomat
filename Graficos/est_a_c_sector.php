...
$title = new title("CANTIDAD DE CLIENTES ACTIVOS Y CORTADOS DE ".strtoupper($nombre_sector));
...
function llamarGrafico(){
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_c_sector.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&";
	}
}
function imprimirGrafico(){
	...
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_c_sector_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&";
	}
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS MENSUALES DE CLIENTES ACTIVOS Y CORTADOS POR SECTORES</div>
		</td>
	</tr>
	<tr>
		...
		<table border="1" width="650px" align="center" cellpadding="4" cellspacing="0"> 
			<tr>
				<td colspan="5" ALIGN="CENTER">
					<span class="estilocabeN">RESUMEN DE CLIENTES ACTIVOS Y CORTADOS DE <?php echo  strtoupper($nombre_sector)?>
					</span>
				</td>
			</tr>
