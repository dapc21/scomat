...
$title = new title("CANTIDAD DE $nombre_det_orden DE ".strtoupper($nombre_zona));
...
function llamarGrafico(){
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_o_zona.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&id_det_orden="+document.f1.id_det_orden.value+"&id_tipo_orden="+document.f1.id_tipo_orden.value+"&id_zona="+document.f1.id_zona.value+"&";
	}
}
...
function imprimirGrafico(){
	...
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_o_zona_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&id_det_orden="+document.f1.id_det_orden.value+"&id_tipo_orden="+document.f1.id_tipo_orden.value+"&id_zona="+document.f1.id_zona.value+"&";
	}
}
</script>
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS ANUALES DE <?php echo strtoupper(utf8_decode($nombre_det_orden));?> POR ZONA</div>
		</td>
	</tr>
	<tr>
