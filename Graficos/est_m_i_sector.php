...
function llamarGrafico(){
	location.href="est_m_i_sector.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&inicio_a="+document.f1.anio_i.value+"&";
	
}

function imprimirGrafico(){
	post_image(false);
	location.href="est_m_i_sector_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&inicio_a="+document.f1.anio_i.value+"&";
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS MENSUALES DE INGRESOS Y DEUDAS POR SECTOR</div>
		</td>
	</tr>
	<tr>
