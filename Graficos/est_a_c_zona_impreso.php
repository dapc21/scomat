...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->MultiCell(190,7,utf8_decode('ESTADISTICAS ANUALES DE CLIENTES ACTIVOS Y CORTADOS POR ZONAS'),'0','C');
	...
	for($j=$inicio_a;$j<=$fin_a;$j++){
		...
		$this->Ln();
		$this->SetX(15);
		$this->Cell(190,6,'RESUMEN DE CLIENTES ACTIVOS Y CORTADOS DE '.strtoupper($nombre_zona),"0",0,"C");
		$this->Ln();
