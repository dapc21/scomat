...
function llamarGrafico(){
	location.href="est_m_c_sector.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&anio="+document.f1.anio.value+"&";
}
function imprimirGrafico(){
	post_image(false);
	location.href="est_m_c_sector_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_sector="+document.f1.id_sector.value+"&anio="+document.f1.anio.value+"&";
