...
class PDF extends FPDF
{
	...
	function Cuerpo($acceso,$inicio_a,$fin_a,$id_det_orden,$id_tipo_orden,$id_sector)
	{
		...
		$this->SetXY(20,30);
		$this->Cell(190,6,'AÑO INICIO: '.$inicio_a.'          AÑO FIN: '.$fin_a.'         ZONA: '.strtoupper($nombre_zona).'          SECTOR: '.strtoupper($nombre_sector),"0",0,"L");
...
$pdf->AddPage();
$pdf->Cuerpo($acceso,$inicio_a,$fin_a,$id_det_orden,$id_tipo_orden,$id_sector);
