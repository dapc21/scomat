...
$acceso->objeto->ejecutarSql("SELECT id_sector FROM calle where id_calle='$id_calle'");
$row=row($acceso);
...
function llamarGrafico(){
	location.href="est_m_i_calle.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_calle="+document.f1.id_calle.value+"&inicio_a="+document.f1.anio_i.value+"&";
	
}

function imprimirGrafico(){
	post_image(false);
	location.href="est_m_i_calle_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_calle="+document.f1.id_calle.value+"&inicio_a="+document.f1.anio_i.value+"&";
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS MENSUALES DE INGRESOS Y DEUDAS POR CALLE</div>
		</td>
	</tr>
	<tr>
