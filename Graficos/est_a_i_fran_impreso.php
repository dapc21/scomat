...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->MultiCell(190,7,utf8_decode('ESTADISTICAS ANUALES DE INGRESOS Y DEUDAS POR FRANQUICIAS'),'0','C');
	...
	function Cuerpo($acceso,$inicio_a,$fin_a)
	{
		$this->SetXY(20,30);
...
$pdf->AddPage();
$pdf->Cuerpo($acceso,$inicio_a,$fin_a);
