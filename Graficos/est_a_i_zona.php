...
function llamarGrafico(){
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_i_zona.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_zona="+document.f1.id_zona.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&";
	}
}
...
function imprimirGrafico(){
	...
	if(parseInt(document.f1.anio_i.value)>parseInt(document.f1.anio_f.value)){
		...
		location.href="est_a_i_zona_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_zona="+document.f1.id_zona.value+"&inicio_a="+document.f1.anio_i.value+"&fin_a="+document.f1.anio_f.value+"&";
	}
...
<table border="0" width="760px" align="center"> 
	<tr>
		<td colspan="2" ALIGN="CENTER">
			<div class="cabe">ESTADISTICAS ANUALES DE INGRESOS Y DEUDAS POR ZONAS</div>
		</td>
	</tr>
	<tr>
