...
function llamarGrafico(){
	location.href="est_m_c_calle.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_calle="+document.f1.id_calle.value+"&anio="+document.f1.anio.value+"&";
}
function imprimirGrafico(){
	post_image(false);
	location.href="est_m_c_calle_impreso.php?&tipoGrafico="+document.f1.tipoGrafico.value+"&id_calle="+document.f1.id_calle.value+"&anio="+document.f1.anio.value+"&";
			...
			<td colspan="2" ALIGN="CENTER" class="estilocabeN">
				<table border="0" width="760px" align="center"> 
					...
					<tr>
						...
						<td>
							<select name="id_sector" id="id_sector" onchange="cargarCalle()" style="width: 150px;">
								<?php echo cargarSectorEst($acceso,$id_zona);?>
							</select>
						</td>
						<td class="estilocabeN">
							calle
						...
						<td>
							<select name="id_calle" id="id_calle" onchange="llamarGrafico()" style="width: 150px;">
