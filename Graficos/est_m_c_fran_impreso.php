...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->MultiCell(190,7,utf8_decode('ESTADISTICAS MENSUALES DE CLIENTES ACTIVOS Y CORTADOS POR FRANQUICIAS'),'0','C');
	...
	function Cuerpo($acceso,$anio)
	{
		$this->SetXY(20,30);
		$this->Cell(190,6,'AÑO: '.$anio,"0",0,"L");
