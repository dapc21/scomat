...
class PDF extends FPDF
{
	...
	function Cuerpo($acceso,$anio,$id_det_orden,$id_tipo_orden,$id_sector)
	{
		...
		$this->SetXY(20,30);
		$this->Cell(190,6,'AÑO: '.$anio.'         ZONA: '.strtoupper($nombre_zona).'          SECTOR: '.strtoupper($nombre_sector),"0",0,"L");
...
$pdf->AddPage();
$pdf->Cuerpo($acceso,$anio,$id_det_orden,$id_tipo_orden,$id_sector);
