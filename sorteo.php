...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->SetY(10);
		$this->MultiCell(190,7,cable tv,'0','C');
		$this->MultiCell(190,7,tv por cable,'0','C');
		$this->MultiCell(190,7,_('lista de contrato para sorteo en navidad'),'0','C');
	...
	function Cuerpo($acceso,$where)
	{
		...
		$dato=lectura($acceso,"select nro_contrato from contrato_servicio,contrato where contrato_servicio.id_contrato=contrato.id_contrato and fecha_inst='$fec' and id_serv='SER00001' and status_con_ser='PAGADO' ORDER BY nro_contrato");
		...
		$this->SetX(15);
		$this->Cell(35,9,_("total participantes").": ".count($dato) ,"0",0,"J",0);
