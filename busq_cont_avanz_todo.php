...
<body bgcolor="#ffffff">
<div class="cabe"><?php echo _("busqueda avanzada general");?></div>
<script>
...
<table border="0" width="780px" align="CENTER" > 
 <tr>
  <td>
	<fieldset >
	  <legend ><?php echo _("parametros de la busqueda");?></legend>
	...
	<table border="0" width="100%" align="CENTER">
		...
		<tr>
			...
			<td>
				<input style="width: 180px;" type="text" name="nombre" maxlength="30" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
			<td>
			...
			<td>
				<input style="width: 180px;" type="text" name="apellido" maxlength="30" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
		...
		<tr>
			...
			<td>
				<input style="width: 180px;" type="text" name="etiqueta" maxlength="11" size="15" value="" onKeyPress="return buscarC_todo(event)">
			</td>
			...
			<td>
				<input style="width: 180px;" type="text" name="fecha_contrato" id="fecha_contrato" maxlength="10" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input style="width: 180px;" type="text" name="telefono" maxlength="11" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
			<td>
			...
			<td>
				<input style="width: 180px;" type="text" name="telf_casa" maxlength="11" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<input style="width: 180px;" type="text" name="numero_casa" maxlength="10" size="15" value=""  onKeyPress="return buscarC_todo(event)">
			</td>
		...
		<tr>
			<td colspan="4" rowspan="1">
				...
				<div align="center">
					<input  type="button" name="registrar" value="Buscar" onclick="buscarContAvanz_todo()">
