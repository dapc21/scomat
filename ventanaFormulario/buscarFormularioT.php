...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  >		
	...
	<section class="panel">
		...
		<header class="panel-heading">parametros de para la búsqueda Avanzada de todas las franquicias</header>
			<div class="panel-body" bgcolor="#ffffff">	
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">			
					...
					<div class="form-group col-lg-6 col-md-4 col-sm-12 col-xs-12">
						<label>nombre</label>												
						<input class="form-control" type="text" id="bnombre" maxlength="30" size="15" value="" onKeyPress="return buscarCT(event)">
					</div>	
					
					<div class="form-group col-lg-6 col-md-4 col-sm-12 col-xs-12">
						<label>apellido</label>												
						<input class="form-control" type="text" id="bapellido" maxlength="30" size="15" value=""  onKeyPress="return buscarCT(event)">
					</div>	
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>rif/cédula</label>												
						<input class="form-control" type="text" id="bcedula" maxlength="10" size="15" value="" onKeyPress="return buscarCT(event)">
					</div>
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>nro abonado</label>												
						<input class="form-control" type="text" id="bnro_contrato" maxlength="100" size="15" value="" onKeyPress="return buscarCT(event)">
					</div>

					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>contrato fisico</label>												
						<input class="form-control" type="text" id="bcontrato_fisico" maxlength="10" size="15" value="" onKeyPress="return buscarCT(event)">
					</div>										
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>precinto</label>												
						<input class="form-control" type="text" id="betiqueta" maxlength="11" size="15" value="" onKeyPress="return buscarCT(event)">
					</div>
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>Fecha</label>
						<input class="form-control form-control-inline input-medium default-date-picker" data-mask="99/99/9999" type="text" id="bfecha_contrato" maxlength="10" size="15" value=""  onKeyPress="return buscarCT(event)">
					</div>	
					...
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>celular</label>
						<input class="form-control" type="text" id="btelefono" maxlength="11" size="15" value=""  onKeyPress="return buscarCT(event)">
					</div>
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>teléfono</label>
						<input class="form-control" type="text" id="btelf_casa" maxlength="11" size="15" value=""  onKeyPress="return buscarCT(event)">
					</div>
					
					<div class="form-group col-lg-3 col-md-4 col-sm-12 col-xs-12">
						<label>nro casa / apto</label>
						<input class="form-control" type="text" id="bnumero_casa" maxlength="10" size="15" value=""  onKeyPress="return buscarCT(event)">
					</div>
